...
print(raw_backslash)
#Sequencec objects can use several operators and functions
sub_text = 'double'
...
print('sub_text not in quote_1 return', sub_text not in quote_1)
...
print('why_1.find("X") returns', why_1.index('X'))
...
print('",".join(["a", "b", "c"]) retunrs', ",".join(["a", "b", "c"]))
